...
if "GITHUB_REPOSITORY" not in os.environ:
    os.environ["GITHUB_REPOSITORY"] = "your-username/your-repo" # Replace with your actual repo for local GitHub testing
...
if "BETTER_MORNING_LLM_API_KEY" not in os.environ:
    ...
    print("WARNING: BETTER_MORNING_LLM_API_KEY not set. Using a dummy key. LLM calls will likely fail or use a default.")
